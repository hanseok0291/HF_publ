...
function provision1Popup() {
    ...
    window.open(url, "이용약관", "width=960, height=760, top=0, left=0, scrollbars=no");
}
// 전자금융거래 이용약관
function provisionPopup() {
    var url = "../provision/provision.html";
    window.open(url, "전자금융거래 이용약관", "width=960, height=760, top=0, left=0, scrollbars=no");
}
// 개인정보처리방침
function privacyPopup() {
    var url = "../provision/privacy.html";
    window.open(url, "개인정보처리방침", "width=960, height=760, top=0, left=0, scrollbars=no");
}
