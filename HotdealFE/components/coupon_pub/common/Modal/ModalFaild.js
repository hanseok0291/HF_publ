      ...
      >
        <div className={`${styleModal.success}`}>
          ...
          <div className={`${styleModal.modalBody} ${styleFilter.modalBody}`}>
            ...
            >
              ...
              <div style={{ display: "block" }}>
                ...
                >
                  <button
                    type="button"
                    className={`${styleCommon.allCenterWrap} ${styleCommon.btn} ${stylePay.btn} ${stylePay.btnRefresh}`}
                  >
                    <i className={`${stylePay.icoRefresh}`}></i>
                    다시 시도하기
                  </button>
                </div>
                {/* //자동 결제 적용 설정 안내 */}
            ...
            <div
              className={`${styleModal.modalBottom}`}
              style={{ display: "none" }}
            >
