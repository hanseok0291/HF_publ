...
$(function(){
	...
	// 			var $this = $(this);
	// 			if ($this.next('.accordion-item').css('display') == 'none') {
	...
	$(".accordion-list .list-header button").click(function(){
		...
		// 목록 상단으로 스크롤
		// setTimeout(function(){
		// 	var thisOffset = $(thisItem).offset().top;
		// 	var listOffset = $(".faq-list").offset().top + 10; // 상단 여백 10px
		// 	$("html, body").animate({
		// 		scrollTop: thisOffset - listOffset
		// 	}, 200);
		// }, 210);
	});
