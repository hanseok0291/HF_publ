...
var errTitle = {
					...
					unknown:			"",//"알 수 없는 오류"
					authCntOver:		"요청 횟수 초과"//"알 수 없는 오류"
			};
...
var errMsg = {
				...
				mobileNoInput:		"휴대폰 번호 입력값이 잘못되었습니다.",
				...
				arsAuthWaiting:		"인증처리가 완료되지 않았습니다.<br>잠시 후 다시 시도해 주세요.",
				arsCallCheck:		"ARS 인증이 정상적으로 완료되지 않았습니다.<br>ARS를 다시 요청해주세요.",
				arsAccountInput:	"계좌정보가 잘못되었습니다.",
				accountInput:		"계좌번호가 잘못되었습니다.",
				passwordInput:		"비밀번호 숫자 6자리가 입력되지 않았습니다.",
				passwordInvalid:	"비밀번호가 유효하지 않습니다.<br>중복 숫자, 생년월일, 휴대폰 번호는<br> 사용할 수 없습니다.",
				...
				unknown:			"오류가 발생하였습니다.",
				authCntOver:		"인증 요청 횟수를 초과했습니다.<br>ARS인증을 진행해 주세요."
			};
...
var alertTitle = {
				...
				withdraw:			"",//"서비스 해지",
				unknown:			"",//"기타 알림"
				passAuthUnreg:		"PASS 인증 미가입 안내",//"pass 인증 미가입 안내"
				passNoCert:			"PASS 인증서 미발급 안내"//"pass 인증 미발급 안내"
};

var alertMsg = {
				agreeAllCheck:			"모든 약관에 동의해야 서비스 이용이 가능합니다.",
				selfAuthSend:			"인증번호가 발송되었습니다.<br>인증번호를 입력해 주세요.",
				...
				passwordPhoneMatch:		"휴대폰 번호는 계좌 등록을 할 수 없습니다.<br>등록 가능한 계좌번호를 입력해 주세요.",
				passwordMismatch:		"비밀번호가 일치하지 않습니다.<br>다시 입력해 주세요.",
				passwordSettingSucc:	"비밀번호가 재설정되었습니다.",
				...
				resetPassword:			"개인 정보 확인 및 보호를 위해 <br>휴대폰 본인인증 후 결제 비밀번호를 <br> 재설정하실 수 있습니다.",
				accountAllDelete:		"마지막 계좌를 삭제하면,<br> 계좌 삭제 후 진행 중인 결제창이 닫힙니다.",
				withdrawMessage:		"간편결제 서비스가 해지되었습니다.<br>서비스를 이용해 주셔서 감사합니다.",
				withdrawSucc:			"서비스 해지되었습니다.<br>이용해 주셔서 감사합니다.",
				removeBankPrev:			"삭제하시겠습니까?",
				removeBankPrevSucc:		"삭제되었습니다.",
				removeBankSel:			"삭제할 계좌를 선택해 주세요.",
				removeBankEmpty:		"삭제할 계좌가 없습니다.",
				registSucc:				"등록되었습니다.",
				passAuthUnreg:			"회원님은 PASS 인증 미가입 상태입니다.<br>PASS App 설치 및 가입 후 PASS App을 통해 인증을 완료해주세요.<br>PASS인증이 어렵다면 ARS 인증을 이용해주세요.",
				passNoCert:				"회원님은 PASS 인증서 미발급 상태입니다.<br>PASS 인증서를 발급 후 인증을 완료해주세요.<br>PASS인증이 어렵다면 ARS 인증을 이용해주세요.",
				acntStatErrMsg:			"해당 계좌의 상태 오류로 계좌 등록이 불가합니다.<br>다른 계좌정보를 입력해주세요."
};
