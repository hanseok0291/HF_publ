...
import CouponDetailSmall from "../../../components/coupon_pub/detail/CouponDetailSmall";
...
const Index = () => {
  ...
  const [isFixedTop, setFixedTop] = useState(true);
  ...
  return (
    <>
      <Layout>
        ...
        />
        <div
          className={`${styleDefaultLayout.defaultContent} ${styleDefaultLayout.wrap} ${styleCouponDetail.detailFixed}`}
        >
          <CouponDetailSmall isfixedTop={isFixedTop} />
        </div>
