...
<div class="modal-body">
    ...
    <h2 class="title-text"><span>개인정보 처리방침</span></h2>
    <div class="detail-wrap">
        <div>
            주식회사 헥토이노베이션(이하 “회사”)은 라운드를 이용하는 이용자의
        ...
        <table class="rround-terms-table rround-center-table">
            ...
            <tr>
                <td class="cell-content cell-img">
                    <img src="${resourcePath}terms/images/label/label_1.png" alt="처리항목" />
                    <br />
                    <a href="#" onclick="event.preventDefault(); openTerm('privacyterms011');">일반 개인정보 수집</a>
                    ※ 세부 항목은 개인정보 처리방침 본문 확인
                </td>
                <td class="cell-content cell-img">
                    <img src="${resourcePath}terms/images/label/label_2.png" alt="처리목적" />
                    <br />
                    <a href="#" onclick="event.preventDefault(); openTerm('privacyterms011');">개인정보 처리목적</a>
                    ※ 세부 항목은 개인정보 처리방침 본문 확인
                </td>
                <td class="cell-content cell-img">
                    <img src="${resourcePath}terms/images/label/label_3.png" alt="보유기간" />
                    <br />
                    개인정보의 보유 기간<br />
                    ※ 세부 항목은 개인정보 처리방침 본문 확인
                </td>
            ...
            <tr>
                <td class="cell-content cell-img">
                    ...
                    <br />
                    <a href="#" onclick="event.preventDefault(); openTerm('privacyterms012');">개인정보의 제공</a>
                    ※ 세부 항목은 개인정보 처리방침 본문 확인
                </td>
                <td class="cell-content cell-img">
                    <img src="${resourcePath}terms/images/label/label_4.png" alt="처리 위탁" />
                    <a href="#" onclick="event.preventDefault(); openTerm('privacyterms013');">처리 위탁</a>
                    ※ 세부 항목은 개인정보 처리방침 본문 확인
                </td>
                <td class="cell-content cell-img">
                    <img src="${resourcePath}terms/images/label/label_7.png" alt="고충처리부서" />
    ...
    <ul class="inner-text no-desc">
        ...
        <li>
            <button type="button" data-target="section-2">
                ② 제3자 제공 및 위탁
            </button>
        </li>
        <li>
        ...
        <li>
            <button type="button" data-target="section-5">
                ⑤ 이용자 및 법정대리인의 권리와 의무 행사 방법
            </button>
        </li>
        <li>
            <button type="button" data-target="section-6">
                ⑥ 개인정보보호책임자 및 담당 부서
            </button>
        </li>
        <li>
            <button type="button" data-target="section-7">
                ⑦ 개인정보처리방침 변경 고지 및 시행 
            </button>
        </li>
    </ul>
    <br /><br />
    <div class="terms-tit f18" id="section-1">① 개인정보 수집과 이용</div>
    <div>
    ...
    <ul class="inner-text no-desc">
        <li>
            <span class="b1f15">1. 라운드 앱에서 수집하는 정보</span>
            <ul class="inner-text no-desc">
                <li>
                    <a href="#" onclick="event.preventDefault(); openTerm('privacyterms011');">🔍 서비스별 개인정보 수집 내역 자세히 보기</a></strong>
                </li>
            </ul>
        </li>
        <li>
            <span class="b1f15">2. 정보주체 이외로부터 수집한 정보(제휴사로부터 제공받는 정보)</span>
            <ul class="inner-text no-desc">
                <li>
                    ...
                    ><span class="arrow">▶</span> 🔍 정보주체 이외로부터 수집한 개인정보 자세히
                        보기</strong
                    >
                    <div class="rround-table-scroll hide">
                        <table class="rround-terms-table">
                            ...
                            <tr>
                                ...
                                <td class="cell-content">
                                    서비스 이용을 위한 본인 확인 및 식별
                                </td>
                                <td class="cell-content">(주)카카오, (주)네이버</td>
                            </tr>
                            <tr>
                                <td class="cell-content">계정</td>
                                <td class="cell-content">SNS 간편로그인</td>
        ...
        <li>
            <span class="b1f15">3. 상담 및 민원 처리 과정에서 수집한 정보</span>
            <p class="table-tit">
            ...
            <ul class="inner-text no-desc">
                <li>
                    <strong class="toggle-table"
                    ><span class="arrow">▶</span> 🔍 상담 및 민원 처리 과정에서 수집된 개인정보 자세히
                        보기</strong
                    >
                    <div class="rround-table-scroll hide">
                        <table class="rround-terms-table">
                            ...
                            <tbody>
                            <tr>
                                <td class="cell-content">라운드 앱 내 고객센터</td>
                                <td class="cell-content">고객 민원 해결</td>
                                <td class="cell-content">
                                    이름(국문 및 영문), 휴대전화번호, 서비스 이용 정보
                                </td>
                                <td class="cell-content">
                                    전자상거래법에 근거한 기간 보존 후 파기<br />
                                    (탈퇴 후 3년 동안 분리보관하여 파기)
                                </td>
                            </tr>
                            </tbody>
                        </table>
        ...
        <li>
            <span class="b1f15">4. 자동 생성으로 수집된 정보 (및 행태 정보의 처리)</span>
            <p class="table-tit">
                서비스 이용 과정이나 개인정보 처리 과정에서도 정보들이
                자동으로 생성 및 수집될 수 있습니다.
            </p>
            <strong><a href="#" onclick="event.preventDefault(); openTerm('privacyterms014');">🔍 자동 생성으로 수집된 정보 자세히 보기</a></strong>
            <div class="terms-con">
                <span class="b1f15">추가 안내 사항</span>
                <ul class="inner-text">
                    <li>
                        이용자의 라운드 서비스 이용이 처음인 경우 필수적인 정보
                        입력을 요청할 수 있으며, 라운드가 이미 보유하고 있는
                        정보가 있다면 입력을 생략하거나 이용자를 위하여 입력
                        편의성을 제공할 수 있습니다.
                    </li>
                    <li>
                        관계 법령에 따라 정보 및 기능성 메시지(결제 내역, 개인정보
                        처리 정기적 안내, 광고·마케팅 수신 동의 고지 등)는
                        이용자의 동의 없이 발송될 수 있습니다. 이는 등록된
                        연락처를 통해 발송되며, 광고성 정보에 대한 것은 선택적으로
                        동의한 이용자에게만 전송됩니다.
                    </li>
                </ul>
            </div>
    ...
    <br/><br/>
    <div class="terms-tit f18" id="section-2">② 제3자 제공 및 위탁</div>
    <div>
    ...
    <br>
    <p class="table-tit"><strong>1) 제3자 제공</strong></p>
    <p>
    ...
    <ul class="inner-text no-desc">
        <li>
            <div>
                <strong>
                    <a href="#" onclick="event.preventDefault(); openTerm('privacyterms012');">🔍 개인정보 제3자 제공 목록 자세히 보기</a>
                </strong>
            </div>
        </li>
    </ul>
    ...
    <!--  -->
    <br>
    <p class="table-tit"><strong>2) 위탁(및 재위탁)</strong></p>
    <p>
        라운드는 위탁 및 재위탁 계약 체결 시 수탁자가 개인정보를 안전하게
        관리할 수 있도록 확인하고 있습니다.
    </p>
    <ul class="inner-text no-desc">
        <li>
            <strong
            ><a href="#" onclick="event.preventDefault(); openTerm('privacyterms013');">🔍 개인정보 위탁 처리 목록 자세히 보기</a>
            </strong>
        </li>
    </ul>
    <div class="terms-tit f18" id="section-3">③ 보유기간 및 파기</div>
    <p class="table-tit"><strong>1) 보유기간</strong></p>
    <p>
        라운드는 이용자에게 동의 받은 ‘이용 및 보유기간’ 또는 관련 법령에
        따라 개인정보를 보유 및 이용합니다. 서비스마다 수집되는 개인정보에
        대한 보유기간은 &lt;① 개인정보 수집과 이용&gt;에서 확인할 수
        있습니다.
    </p>
    <ul class="inner-text no-desc">
        <li>
            <strong class="toggle-table">
                <span class="arrow">▶</span> 🔍 관련 법령 및 회사 내부 방침에 따른 보존기간 자세히 보기
            </strong>
            <div class="rround-table-scroll hide">
                ...
                <table class="rround-terms-table">
                    ...
                    <tr>
                        ...
                        <td class="cell-content">5년</td>
                        <td class="cell-content">전자상거래법 제6조</td>
                    </tr>
                    <tr>
                        <td class="cell-content">
                    ...
                    <tr>
                        <td class="cell-content">표시ㆍ 광고에 관한 기록</td>
                        <td class="cell-content">6개월</td>
                        <td class="cell-content">전자상거래법 제6조</td>
                    </tr>
                    </tbody>
                </table>
                <p class="table-tit">2) 회사 내부 방침에 따른 보존</p>
                <div class="rround-table-scroll">
                    <table class="rround-terms-table">
                        <thead>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="cell-content">1년</td>
                            <td class="cell-content">라운드 민원 대응</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <p class="table-tit"><strong>2) 파기</strong></p>
    <div class="terms-con">
        (1) 파기 절차
        <p>
    ...
    <div class="terms-con">
        (2) 파기 방법
        <ul class="inner-text no-desc">
            <li>전자적 파일 형태로 저장된 개인정보는 관련 법령에 따라 복구되지 않도록 파기하며, 종이 문서에 기록된 개인정보는 세절하는 방법으로 파기하고 있습니다.
            </li>
        </ul>
    </div>

    <div class="terms-con">
        <strong>💡 서비스 장기 미이용에 대한 사항</strong>
        <p class="table-tit">
        ...
        <p>
            ...
            접속하시면 다양한 혜택을 받을 수 있습니다. 데이터 보관을 원하지
            않는 고객께서는 라운드 앱 설정 메뉴(마이페이지 → ⚙️설정 → 약관
            및 개인정보 처리 동의)에서 탈퇴를 진행할 수 있습니다.
        </p>
    </div>
    <br/><br/>
    <div class="terms-tit f18" id="section-4">
        ④ 개인정보의 안전성 확보 조치
    </div>
    <p>
    ...
    <br/><br/>
    <div class="terms-tit f18" id="section-5">
        ⑤ 이용자 및 법정대리인의 권리와 의무 행사 방법
    </div>
    ...
    <ul class="inner-text">
        <li>
            ...
            <ul class="inner-text no-desc">
                ...
                <li><strong> 3. 삭제 및 철회 요구</strong></li>
                <li><strong> 4. 처리정지 요구</strong></li>
                <li>
                    <strong> 5. 신용정보 이용 및 제공사실 통보 요구 </strong>
                </li>
            </ul>
        </li>
        <li>
        ...
        <li>
            ...
            <a href="https://law.go.kr" target="_blank">&lt;개인정보 처리 방법에 관한 고시의 별지 제11호 서식&gt;</a>에 따른
            위임장을 제출해야 합니다.
        </li>
        <li>
    ...
    <ul class="inner-text no-desc">
        <li>
            ...
            >1. 회원 탈퇴 시 필수 동의를 포함하여 모든 동의가 자동으로
                철회됩니다.<br/>
                2. 서비스 이용 동의의 경우, 마이페이지 → 설정 → 약관 및 개인정보 처리 동의
                → (서비스별) 약관 및 동의문 내 [동의 철회하기] 버튼을 통해
                동의를 철회할 수 있습니다.<br/>
                3. 광고/마케팅 수신 동의의 경우, 마이페이지 → 설정 → 알림 설정에서 원하는 발송 채널(앱 푸시,
    ...
    <br/><br/>
    <div class="terms-tit f18" id="section-6">
        ⑥ 개인정보보호책임자 및 담당 부서
    </div>
    <p class="table-tit">
    ...
    <ul class="inner-text no-desc">
        <li>
            ...
            개인정보보호 관련 문의, 불만 처리, 상담 및 피해규제 등에 관한
    ...
    <div class="rround-table-scroll">
        <table class="rround-terms-table">
            ...
            <tbody>
            <tr>
                <td class="cell-content">개인정보침해 신고센터</td>
                <td class="cell-content">(국번없이) 118</td>
                <td class="cell-content"><a href="https://privacy.kisa.or.kr" target="_blank">privacy.kisa.or.kr</a></td>
            </tr>
            <tr>
                <td class="cell-content">개인정보 분쟁조정위원회</td>
                <td class="cell-content">1833-6972</td>
                <td class="cell-content"><a href="https://www.kopico.go.kr" target="_blank">www.kopico.go.kr</a></td>
            </tr>
            <tr>
                <td class="cell-content">대검찰청 사이버수사과</td>
                <td class="cell-content">(국번없이) 1301</td>
                <td class="cell-content"><a href="https://www.spo.go.kr" target="_blank">www.spo.go.kr</a></td>
            </tr>
            <tr>
                <td class="cell-content">
                    경찰청 사이버안전국(경찰민원콜센터)
                ...
                <td class="cell-content"><a href="https://ecrm.cyber.go.kr" target="_blank">ecrm.cyber.go.kr</a></td>
            </tr>
            </tbody>
        </table>
    </div>
    <br/><br/>
    <div class="terms-tit f18" id="section-7">
        ⑦ 개인정보처리방침 변경 고지 및 시행
    </div>
    <p class="table-tit">
        이 &lt;개인정보처리방침&gt; 은 2025. 6. 12. 부터 적용됩니다.
        <br />
