...
<div class="modal-body">
    ...
    <br />
    <p class="table-tit"><strong>1) 자동 생성으로 수집된 정보</strong></p>
        ...
        <table class="rround-terms-table">
            ...
            <tr>
                ...
                <td class="cell-content">
                    - 서비스 이용 정보: 웹/앱 서비스 접속 및 사용 기록(페이지뷰, 클릭, 검색 등), 서비스 이용 기록(측정된 걸음 수,
                    닉네임, 프로필, 게시물 작성 및 조회 이력 등), 구매 및 검색 이력(주문/배송/취소/교환/환불 등의 커머스 정보), 가입 및 탈퇴 정보, 고객의 관심ㆍ기호ㆍ흥미 등의 성향 정보
                    <br />
            ...
            <tr>
                ...
                <td class="cell-content">
                    ...
                    서비스 방문 및 이용기록의 분석에 기반한 개인화•맞춤형 서비스 서비스 제공, 맞춤형 UI 제공, 서비스 품질 개선,  신규 서비스 및 제품 개발을 위한 연구분석, 맞춤형 레포트 제공, AI기술 등을 결합한 신규 서비스 요소 발굴 및 제공,
                    서비스 제공 관련 고객상담, 민원처리,
                    공지사항 전달, 서비스 대상자 선정 등의 목적<br />
                            ...
                            <table class="rround-terms-table">
                                ...
                                <tr>
                                    ...
                                    <td class="cell-content">
                                        ...
                                        - 웹브라우저 오른쪽 상단 ‘⋮’ 표시 선택 > 새 시크릿 창 <br />
                                        2. 기록 삭제<br />
                                        - 웹 브라우저 설정 > 개인정보 보호 및 보안 > 인터넷 사용 기록 삭제<br />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="cell-content">
                                        ...
                                        - 웹 브라우저 오른쪽 상단 ‘…’ 표시 선택 > 새 InPrivate 창<br />
                                        2. 기록 삭제<br />
        ...
        <table class="rround-terms-table">
            ...
            <tr>
                ...
                <td class="cell-content">
                    ...
                    개인화된 데이터 분석 및 컨설팅, 맟춤형 광고 및 마케팅 제공<br />
            ...
            <tr>
                ...
                <td class="cell-content">
                    ...
                    • 선택 항목: 자동수집을 통해 수집한 행태정보 중 마케팅 목적 개인정보 활용에 동의한 고객에 한해 수
                </td>
            </tr>
            <tr>
    ...
    <div class="rround-table-scroll">
        <table class="rround-terms-table">
            ...
            <tr>
                <td class="cell-content">제공받는 자</td>
                <td class="cell-content">(주)코비그룹</td>
            </tr>
            <tr>
                <td class="cell-content">제공 항목</td>
                <td class="cell-content">
            ...
            <tr>
                <td class="cell-content">제공 목적</td>
                <td class="cell-content">
                    • 라운드 또는 제휴사 제품에 대한 맞춤형 서비스 제공, 개인화된 데이터 분석 및 컨설팅<br />
                    • 서비스 품질 개선 및 신규 서비스 발굴<br />
                    • 라운드앱 및 서비스 이용현황에 대한 분석
                </td>
            </tr>
