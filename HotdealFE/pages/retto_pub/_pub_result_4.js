...
import BottomSheetMissionSuccess from "../../components/retto_pub/common/modal/BottomSheetMissionSuccess";
import BottomSheetMissionFail from "../../components/retto_pub/common/modal/BottomSheetMissionSuccess";
  ...
  return (
    <>
      ...
      <ul className={styleMyretto.tabWrap}>
        <li>나의 리또 현황</li>
        <li>리또 스탬프</li>
        <li className={styleMyretto.active}>당첨 리또</li>
      </ul>
      <Container> 
        {/* <MyPage /> */}
        {/* <Stamp /> */}
