    ...
    <div class="rround-table-scroll">
        <table class="rround-terms-table">
            ...
            <tr>
                ...
                <td class="cell-content">회원 탈퇴 후 90일까지<br />(단, 관련 법령에 별도 규정이 명시되어 있는 경우 그 기간에 따름)</td>
            </tr>
            <tr>
                <td class="cell-content">공통 및 일반</td>
            ...
            <tr>
                ...
                <td class="cell-content">
                  닉네임, 프로필 사진, 서비스 이용 관련 정보(액세스 로그 등), 신체 활동 정보(걸음 수), 개인위치정보
                </td>
                <td class="cell-content">
                  - 피드 서비스 제공 및 운영(게시물·댓글/답글 작성, 콘텐츠 표시 및 저장 등)<br />
                  - 피드 내 메시지 서비스 제공 및 운영, 이용자 식별 및 관리<br />
                  - 걸음 수 측정을 통한 챌린지 참여 및 표기<br />
                  - 이용자의 위치 정보를 활용한 챌린지 운영 및 참여에 따른 보상 제공
                </td>
                <td class="cell-content">
                  회원 탈퇴 또는 동의 철회 시까지<br />
                  (단, 개인 위치정보는 위치기반 챌린지 종료 시까지 보관합니다)
                </td>
            </tr>
            <tr>
                <td class="cell-content">서비스</td>
            ...
            <tr>
                ...
                <td class="cell-content">
                  이름, 생년월일, 성별, 휴대전화번호, CI(연계정보), 암호화된 고객번호, 서비스 이용 관련 정보(액세스 로그, 서비스 이용 내역)
                </td>
                <td class="cell-content">
