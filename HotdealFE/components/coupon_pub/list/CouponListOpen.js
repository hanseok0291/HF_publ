      ...
      >
        ...
        <div className={`${styleCommon.container}`}>
          <div className={`${styleCouponList.containerWrap}`}>
            <ul
              className={`${styleCouponList.CouponList} ${styleCouponList.CouponListVoid}`}
            >
              <li className={`${styleCouponList.CouponItem}`}>
                <button href={`/coupon_pub/`}>
                  <div className={styleCouponList.imgBox}></div>
                  <div className={styleCouponList.infoBox}>
                    <p className={styleCouponList.infoBrand}></p>
                    <p className={styleCouponList.infoProduct}></p>
                    <p className={styleCouponList.infoPrice}></p>
                    <p
                      className={`${styleCouponList.infoDcPrice} ${styleCouponList.infoDcPriceSmall}`}
                    ></p>
                    <p className={styleCouponList.infoDcPrice}></p>
                    <p className={styleCouponList.infoBottomText}></p>
                  </div>
                </button>
              </li>
              <li className={`${styleCouponList.CouponItem}`}>
